...
public class WishlistViewModel extends ViewModel {
    ...
    public void loadProducts() {
        ...
        list.add(new ProductModel(
                3,
                "Nike Sportswear Club Fleece",
                Arrays.asList("https://cdn.isa-aydin.com/wp-content/uploads/2023/05/creative-volume-swatch-makeup-highlighter-dark-golden.jpg.jpg"),
                99.0,
                Category.PANTS,
                true
        ...
        list.add(new ProductModel(
                5,
                "Nike Sportswear Club Fleece",
                Arrays.asList("https://images.rawpixel.com/image_800/cHJpdmF0ZS9sci9pbWFnZXMvd2Vic2l0ZS8yMDIyLTExL3BmLXMxMDgtcG0tNDExMy1tb2NrdXAuanBn.jpg"),
                99.0,
                Category.PANTS,
                true
